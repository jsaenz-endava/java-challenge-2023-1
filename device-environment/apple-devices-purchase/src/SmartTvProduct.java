public class SmartTvProduct extends Product {
    ...
    public SmartTvProduct() {
        ...
        products[0] = new Product("Apple TV 4K", 114.95, "Brings Apple TV+, Apple Music, Apple Fitness+, and Apple Arcade together with all your favorite streaming apps — in our best‑ever picture and audio quality.", "smart tv", 0) {
            @Override
